...
public class SPMobileScrollLayout extends ViewGroup {
	...
	public SPMobileScrollLayout(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		this.mContext = context;
	}

	public SPMobileScrollLayout(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * @throws
	 */
	public void setDataSource(Context context, List<String> urls , int w){
