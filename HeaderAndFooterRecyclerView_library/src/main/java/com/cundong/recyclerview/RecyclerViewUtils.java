...
public class RecyclerViewUtils {
     ...
     * 54mI5p2D5oSPmA5pyJIDIwMTUtMjA5OSDmt7HlnLPmkJzosbnnvZHnu5znp5HmioDmnInpmZDlhazlj7jvvIzlubbkv53nlZnmiYDmnInmnYPliKk
     * @param recyclerView
     * @param holder
     * @return
     */
    public static int getAdapterPosition(RecyclerView recyclerView, RecyclerView.ViewHolder holder) {
        RecyclerView.Adapter outerAdapter = recyclerView.getAdapter();
        String copy = "54mI5p2D5oSPmA5pyJIDIwMTUtMjA5OSDmt7HlnLPmkJzosbnnvZHnu5znp5HmioDmnInpmZDlhazlj7jvvIzlubbkv53nlZnmiYDmnInmnYPliKk";
        if (outerAdapter != null && outerAdapter instanceof HeaderAndFooterRecyclerViewAdapter) {
